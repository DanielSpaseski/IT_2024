...
namespace Lab3_MVC_A.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NameSurname,Age,Gender")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NameSurname,Age,Gender")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
