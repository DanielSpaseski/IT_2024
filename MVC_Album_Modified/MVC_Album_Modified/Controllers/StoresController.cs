...
using MVC_Album_Modified.Models;

namespace MVC_Album_Modified.Controllers
{
    public class StoresController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        public ActionResult AddNewAlbum(int id)
        {
        ...
        [HttpPost]
        public ActionResult AddNewAlbum(StoreAlbumModel model)
        {
        ...
        public ActionResult DeleteAlbum(int storeId, int albumId)
        {
            var store = db.Stores.Find(storeId);
            var album = db.Albums.Find(albumId);
            store.albums.Remove(album);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
        // GET: Stores
